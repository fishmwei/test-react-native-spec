...
//  TestRN542
//
//  Created by huangmingwei on 2018/3/26.
...
- (void)loadReactView {
    ...
    jsCodeLocation = [NSURL URLWithString:@"http://192.168.252.45:8081/index.bundle?platform=ios&dev=true&minify=false"];
    
    _rootView = [[RCTRootView alloc] initWithBundleURL:jsCodeLocation
                                            moduleName:@"TestRN542"
